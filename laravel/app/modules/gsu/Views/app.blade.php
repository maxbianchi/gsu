	...
	<nav class="navbar navbar-default" style="margin-bottom:0px !important">
		<div class="container-fluid">
			<div class="navbar-header">
                ...
                <div style="margin-left: 40%;position: absolute;top: 16px;font-weight: bold;">{{utf8_encode(Session::get('user')['DESCRIZIONE']." ".Session::get('user')['INDIRIZZO']." ".Session::get('user')['LOCALITA']) }}
                    <span style="padding-left:200px!important;color:blue;font-size:22px;font-style:Comic Sans MS;font-style: italic;"><?php !empty($tableName) ? print_r("TABELLA $tableName") : ""?></span>
                </div>
