    ...
    <fieldset class="dettaglio_dati">
        ...
        <table border="0" class="tabella dataTable table table-striped table-bordered display no-footer detail">
            <form action="#" method="post" id="form">
                ...
                <tr>
                    <td>NOME PIANO</td>
                    <td><input type="text" name="nome_piano" value="{{$request['NOME_PIANO'] or ""}}"></td>
                </tr>
                <tr>
                    <td>DESCRIZIONE PIANO</td>
                    <td><input type="text" name="des_piano" value="{{$request['DES_PIANO'] or ""}}"></td>
                </tr>

                <tr>
                    <td colspan="2" style="padding-top:20px;">
                        <input type="hidden" id="id_tbl" name="id_tbl" value="{{$request['ID_PIANO'] or ""}}">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btn_salva").click(function(){
                         $.post( "{{url('/gsu/amministrazionesim-piani-tariffari-dati/save')}}", $("form#form").serialize())
                                .done(function( data ) {
                                    $('#msg').modal('show');
                                    $("#btn_salva").hide();
                                });
