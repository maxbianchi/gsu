        ...
        @foreach($request as $req)
            <tr class="{{$class[$req['MANUTENZIONE']]['GSU']["ELIMINATO"]}}">
                <td>
                    ...
                    <a class="btn-small edit delete stato_right" href="#" data-toggle="modal" title="DELETE" data-manutenzione="{{$req['MANUTENZIONE'] or ""}}" data-delete-id="{{$req['IDIPMULTIMEDIA'] or ""}}"><i class="glyphicon glyphicon-trash"></i> </a>
                </td>
                <td>
