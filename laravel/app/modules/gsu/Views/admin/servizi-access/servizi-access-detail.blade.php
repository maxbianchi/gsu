    ...
    <fieldset class="dettaglio_dati">
        ...
        <table border="0" class="tabella dataTable table table-striped table-bordered display no-footer detail">
            <form action="#" method="post" id="form">
                ...
                <tr>
                    <td>TGU PRIMARIA</td>
                    <td><input type="text" name="tgu_primaria" value="{{$request['TGU_PRIMARIA'] or ""}}"></td>
                </tr>
                <tr>
                    <td>TGU SECONDARIA</td>
                    <td><input type="text" name="tgu_secondaria" value="{{$request['TGU_SECONDARIA'] or ""}}"></td>
                </tr>
                <tr>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $("#btn_salva").click(function(){
                                $.post( "{{url('/gsu/servizi-access/save')}}", $("form#form").serialize())
                                        .done(function( data ) {
                                            $('#msg').modal('show');
                                            $("#btn_salva").hide();
                                        });
