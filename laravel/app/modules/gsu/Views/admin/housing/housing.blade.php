...
@section('content')
        ...
        <div class="border">
            <form method="GET" action="{{url('/gsu/housing/search')}}" name="form_search">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">RICHIESTA</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2"><input type="text" value="{{Input::get('canone')}}" id="tipo" name="tipo" placeholder="TIPO"></div>
                    ...
                    <div class="col-md-2"><input type="text" value="{{Input::get('seriale')}}" id="seriale" name="seriale"  placeholder="SERIALE"></div>
                    <div class="col-md-3"></div>
                </div>
    ...
    <table id="main" class="table table-striped table-bordered display" cellspacing="0" width="100%" style="display:none;">
        ...
        @foreach($request as $req)
            <tr>
                <td>
                    <a class="btn btn-small edit" href="{{url('/gsu/housing/edit')."?id=".$req['IDHOUSING']}}" title="EDIT"><i class="glyphicon glyphicon-pencil"></i> </a>
                    <a class="btn btn-small edit delete" href="javascript:void(0);" data-toggle="modal" title="DELETE" manutenzione="{{$req['MANUTENZIONE'] or ""}}" delete-id="{{$req['IDHOUSING'] or ""}}"><i class="glyphicon glyphicon-trash"></i> </a>
                </td>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btn_elimina").click(function(){
                $.get( "{{url('/gsu/housing/delete')}}", { id: id_elimina, manutenzione: manutenzione } )
                        .done(function( data ) {
                            $("#delete").modal('toggle');
                            $("#cerca").trigger("click");
                        });
