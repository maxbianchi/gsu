        ...
        @foreach($request as $req)
            <tr>
                <td>
                    ...
                    <a class="btn btn-small edit delete" href="javascript:void();" data-toggle="modal" title="DELETE" manutenzione="{{$req['MANUTENZIONE'] or ""}}" delete-id="{{$req['IDMPLS'] or ""}}"><i class="glyphicon glyphicon-trash"></i> </a>
                </td>
