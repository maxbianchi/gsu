...
@section('content')
    ...
    <br><br>
        ...
        <table border="0" class="tabella dataTable table table-striped table-bordered display no-footer detail">
                ...
                <tr>
                    <td>TIPO PASSWORD </td>
                    <td><input type="text" name="tipopassword" value="{{$request['TIPOPASSWORD'] or ""}}"></td>
                </tr>
                <tr>
                    <td>PRODUTTORE </td>
                ...
                <tr>
                    <td colspan="2" style="padding-top:20px;">
                        ...
                        <input type="hidden" id="id_tbl" name="id_tbl" value="{{$request['IDPASSWORD'] or ""}}">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btn_salva").click(function(){
                         $.post( "{{url('/gsu/centralini-pwd/save')}}", $("form#form").serialize())
                                .done(function( data ) {
                                    $('#msg').modal('show');
                                    $("#btn_salva").hide();
                                });
