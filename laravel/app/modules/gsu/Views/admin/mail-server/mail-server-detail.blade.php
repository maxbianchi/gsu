...
@section('content')
            ...
            <form action="#" method="post" id="form">
                ...
                <tr>
                    <td colspan="4" style="padding-top:20px;">
                        ...
                        <input type="hidden" id="id_tbl" name="id_tbl" value="{{$request['IDMAIL_SERVER'] or ""}}">
    ...
    <div id="msg" class="modal fade" style="z-index:99999;">
        ...
        <table class="servizi_collegati" style="width:100%; border: 1px solid #C0C0C0; " cellspacing="3px">
            <tr>
                <td>
                    <a href="{{url('/gsu/search')."?canone=CAN-G104-&cliente=".$request['SOGGETTO']."&cliente_finale=".$request['CLIENTE']."&ubicazione=".$request['DESTINATARIOABITUALE']}}">UTENTE AGGIUNTIVO MAIL SERVER</a>
                </td>
                <td>
                    <a href="{{url('/gsu/search')."?canone=CAN-E08&cliente=".$request['SOGGETTO']."&cliente_finale=".$request['CLIENTE']."&ubicazione=".$request['DESTINATARIOABITUALE']}}">RELAY DI POSTA</a>
                </td>
            </tr>
        </table>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btn_salva").click(function(){
                         $.post( "{{url('/gsu/mail-server/save')}}", $("form#form").serialize())
                                .done(function( data ) {
                                    $('#msg').modal('show');
                                    $("#btn_salva").hide();
                                });
