...
@section('content')
    ...
    <table id="main" class="table table-striped table-bordered display" cellspacing="0" width="100%" style="display:none;">
        ...
        @foreach($request as $req)
            <tr>
                <td>
                    <a class="btn btn-small edit" href="{{url('/gsu/mpls-direct-access/edit')."?id=".$req['IDMPLSDIRECTACCESS']}}" title="EDIT"><i class="glyphicon glyphicon-pencil"></i> </a>
                ...
                <td><a href="{{url($class['link'][$req['CANONE']])."/show?manutenzione=".$req['MANUTENZIONE']."&id=".$req['IDMPLSDIRECTACCESS']}}">{{$req['MANUTENZIONE']}}</a></td>
