...
@section('content')
    ...
    <div id="msg" class="modal fade" style="z-index:99999;">
        ...
        <table class="servizi_collegati" style="width:100%; border: 1px solid #C0C0C0; " cellspacing="3px">
            <tr>
                <td>
                    <a href="{{url('/gsu/assistenza-tecnica-pwd/search')."?cliente=".$request['SOGGETTO']."&cliente_finale=".$request['CLIENTE']."&ubicazione=".$request['DESTINATARIOABITUALE']."&apparato_id=".$request['IDTELEASSISTENZA']."&id=".$request['IDTELEASSISTENZA']."&seriale=".$request['SERIALE']}}">PASSWORD</a>
                </td>
            </tr>
        </table>
        <br>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btn_salva").click(function(){
                         $.post( "{{url('/gsu/assistenza-tecnica-hw/save')}}", $("form#form").serialize())
                                .done(function( data ) {
                                    $('#msg').modal('show');
                                    $("#btn_salva").hide();
                                });
