        ...
        <table border="0" class="tabella dataTable table table-striped table-bordered display no-footer detail">
            <form action="#" method="post" id="form">
                ...
                <tr>
                    ...
                    <td><input type="text" name="gateway_wan_punto_punto" value="{{$request['GATEWAY_WAN_PUNTO_PUNTO'] or ""}}"></td>
                    <td>SUBNET MASK</td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="numero_ip_statici">
                            ...
                            <option value="1" {{isset($request['NUMERO_IP_STATICI']) && $request['NUMERO_IP_STATICI'] == 1 ? 'selected="selected"' : ""  }}>1</option>
                ...
                <tr>
                    <td colspan="4" style="padding-top:20px;">
                        ...
                        <input type="hidden" id="id_tbl" name="id_tbl" value="{{$request['IDDIRECTACCESS'] or ""}}">
    ...
    <div id="msg" class="modal fade" style="z-index:99999;">
        ...
        <table class="servizi_collegati" style="width:100%; border: 1px solid #C0C0C0; " cellspacing="3px">
            <tr>
                ...
                <td>
                    <a href="{{url('/gsu/servizi-access/search')."?cliente=".$request['SOGGETTO']."&cliente_finale=".$request['CLIENTE']."&ubicazione=".$request['DESTINATARIOABITUALE']}}">SERVIZI ACCESS</a>
                </td>
            </tr>
        </table>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btn_salva").click(function(){
                         $.post( "{{url('/gsu/direct-access/save')}}", $("form#form").serialize())
                                .done(function( data ) {
                                    $('#msg').modal('show');
                                    $("#btn_salva").hide();
                                });
