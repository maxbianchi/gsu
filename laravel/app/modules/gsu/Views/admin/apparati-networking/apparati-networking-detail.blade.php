    ...
    <br><br>
        ...
        <table border="0" class="tabella dataTable table table-striped table-bordered display no-footer detail">
                ...
                <tr>
                    ...
                    <td><input type="text" name="scadenza_garanzia" value="{{$request['SCADENZAGARANZIA'] or ""}}"></td>
                </tr>
                <tr>
                    <td>SCADENZA RINNOVO GARANZIA</td>
                    <td><input type="text" name="scarinngaranzia" value="{{$request['SCARINNGARANZIA'] or ""}}"></td>
                </tr>
                <tr>
                    <td>URL FILTERING</td>
                    <td><input type="text" name="url_filtering" value=""></td>
                </tr>
                <tr>
                    <td>SMART NET</td>
                    <td><input type="text" name="smart_net" value=""></td>
                </tr>
                <tr>
                    <td>VPN</td>
                    <td><input type="text" name="vpn" value=""></td>
                </tr>
                <tr>
                    <td>IP MULTIMEDIA</td>
                    <td><input type="text" name="ip_multimedia" value=""></td>
                </tr>
                <tr>
                    <td>GESTIONE APPARATO</td>
                    <td><input type="text" name="gestione_apparato" value=""></td>
                </tr>
                <tr>
                    <td>IP PUBBLICO</td>
