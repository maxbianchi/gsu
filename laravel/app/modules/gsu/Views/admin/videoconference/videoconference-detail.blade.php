    ...
    <fieldset class="dettaglio_dati">
        ...
        <table border="0" class="tabella dataTable table table-striped table-bordered display no-footer detail">
            <form action="#" method="post" id="form">
                ...
                <tr>
                    <td>NUMERO UTENTI</td>
                    <td><input type="text" name="nutenti" value="{{$request['NUTENTI'] or ""}}"></td>
                </tr>
                <tr>
                    <td>SPAZIO WEB</td>
                ...
                <tr>
                    <td colspan="4" style="padding-top:20px;">
                        ...
                        <input type="hidden" id="id_tbl" name="id_tbl" value="{{$request['IDVIDEOCONFERENCE'] or ""}}">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btn_salva").click(function(){
                         $.post( "{{url('/gsu/videoconference/save')}}", $("form#form").serialize())
                                .done(function( data ) {
                                    $('#msg').modal('show');
                                    $("#btn_salva").hide();
                                });
