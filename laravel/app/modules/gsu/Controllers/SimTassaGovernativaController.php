...
class SimTassaGovernativaController extends MainController {
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.sim-tassa-governativa.sim-tassa-governativa", ['request' => $res, 'class' => $class]);
    }
    ...
    public function show(){
        ...
        $res = $return['res'];
        $btn = $return['btn'];
        return view("gsu::$this->view_folder.sim-tassa-governativa.sim-tassa-governativa-detail", ['request' => $res, 'btn' => $btn,'opz' => $opz]);
    }
