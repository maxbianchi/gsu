...
class SimIntercomController extends MainController {
    ...
    private $tableName = "SIM INTERCOM";
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.sim-intercom.sim-intercom", ['request' => $res, 'class' => $class, 'tableName' => $this->tableName]);
    }
    ...
    public function show(){
        ...
        $res = $return['res'];
        $btn = $return['btn'];
        return view("gsu::$this->view_folder.sim-intercom.sim-intercom-detail", ['request' => $res, 'btn' => $btn,'opz' => $opz, 'tableName' => $this->tableName]);
    }
