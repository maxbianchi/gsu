...
class SimOpzioneDatiController extends MainController {
    ...
    private $tableName = "SIM OPZIONE DATI";
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.sim-opzione-dati.sim-opzione-dati", ['request' => $res, 'class' => $class, 'tableName' => $this->tableName]);
    }
    ...
    public function show(){
        ...
        $res = $return['res'];
        $btn = $return['btn'];
        return view("gsu::$this->view_folder.sim-opzione-dati.sim-opzione-dati-detail", ['request' => $res, 'btn' => $btn,'opz' => $opz, 'tableName' => $this->tableName]);
    }
