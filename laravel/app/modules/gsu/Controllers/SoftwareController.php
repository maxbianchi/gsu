...
class SoftwareController extends MainController {
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.software.software", ['request' => $res, 'class' => $class]);
    }
    ...
    public function show(){
        ...
        $res = $return['res'];
        $btn = $return['btn'];
        return view("gsu::$this->view_folder.software.software-detail", ['request' => $res, 'btn' => $btn]);
    }
