...
class ActivesyncController extends MainController {
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.activesync.activesync", ['request' => $res, 'class' => $class]);
    }
    ...
    public function show(){
        ...
        $res = $return['res'];
        $btn = $return['btn'];
        return view("gsu::$this->view_folder.activesync.activesync-detail", ['request' => $res, 'btn' => $btn]);
    }
