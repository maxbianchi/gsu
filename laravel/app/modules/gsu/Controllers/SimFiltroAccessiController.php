...
class SimFiltroAccessiController extends MainController {
    ...
    private $tableName = "SIM FILTRO ACCESSI";
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.sim-filtro-accessi.sim-filtro-accessi", ['request' => $res, 'class' => $class, 'tableName' => $this->tableName]);
    }
    ...
    public function show(){
        ...
        $res = $return['res'];
        $btn = $return['btn'];
        return view("gsu::$this->view_folder.sim-filtro-accessi.sim-filtro-accessi-detail", ['request' => $res, 'btn' => $btn,'opz' => $opz, 'tableName' => $this->tableName]);
    }
