...
use App\Modules\Gsu\Models\HardwareModel;
...
class HardwareController extends MainController {

    private $tableName = "HARDWARE";
    ...
    public function main(){
        $res = new HardwareModel();
        $res = $res->getAllRequest();
        $utility = new Utility();
        $class = $utility->setLinkData($res);
        return view("gsu::$this->view_folder.hardware.hardware", ['request' => $res, 'class' => $class, 'tableName' => $this->tableName]);
    }
    ...
    public function show(){
        ...
        return view("gsu::$this->view_folder.hardware.hardware-detail", ['request' => $res, 'btn' => $btn, 'users' => $users,'assistenzatecnica' => $assistenzatecnica, 'post_warranty' => $post_warranty, 'tableName' => $this->tableName]);
    }
