...
class HardwareController extends MainController {
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.hardware.hardware", ['request' => $res, 'class' => $class]);
    }
    ...
    public function show(){
        ...
        return view("gsu::$this->view_folder.hardware.hardware-detail", ['request' => $res, 'btn' => $btn, 'users' => $users,'assistenzatecnica' => $assistenzatecnica, 'post_warranty' => $post_warranty]);
    }
