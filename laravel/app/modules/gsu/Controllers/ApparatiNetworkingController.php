...
class ApparatiNetworkingController extends MainController {
    ...
    private $tableName = "APPARATI NETWORKING";
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.apparati-networking.apparati-networking", ['request' => $res, 'class' => $class, 'tableName' => $this->tableName]);
    }
    ...
    public function show(){
        ...
        return view("gsu::$this->view_folder.apparati-networking.apparati-networking-detail", ['request' => $res, 'btn' => $btn, 'users' => $users,'urlfiltering' => $urlfiltering, 'smartnet' => $smartnet, 'vpn' => $vpn, 'ipmultimedia' => $ipmultimedia, 'gestioneapparato' => $gestioneapparati, 'tableName' => $this->tableName]);
    }
