...
class DialUpController extends MainController {
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.dial-up.dial-up", ['request' => $res, 'class' => $class, 'tableName' => $this->tableName]);
    }
    ...
    public function show(){
        ...
        $res = $return['res'];
        $btn = $return['btn'];
        return view("gsu::$this->view_folder.dial-up.dial-up-detail", ['request' => $res, 'btn' => $btn, 'tableName' => $this->tableName]);
    }
