...
class MailArchiveController extends MainController {
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.mailarchive.mailarchive", ['request' => $res, 'class' => $class]);
    }
    ...
    public function show(){
        ...
        $res = $return['res'];
        $btn = $return['btn'];
        return view("gsu::$this->view_folder.mailarchive.mailarchive-detail", ['request' => $res, 'btn' => $btn]);
    }
