...
class MailArchiveController extends MainController {
    ...
    private $tableName = "ARCHIVIO MAIL";
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.mailarchive.mailarchive", ['request' => $res, 'class' => $class, 'tableName' => $this->tableName]);
    }
    ...
    public function show(){
        ...
        $res = $return['res'];
        $btn = $return['btn'];
        return view("gsu::$this->view_folder.mailarchive.mailarchive-detail", ['request' => $res, 'btn' => $btn, 'tableName' => $this->tableName]);
    }
