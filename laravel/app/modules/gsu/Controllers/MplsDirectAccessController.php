...
class MplsDirectAccessController extends MainController {
    ...
    public function main(){
        ...
        return view("gsu::admin.mpls-direct-access.mpls-direct-access", ['request' => $res, 'class' => $class]);
    }
    ...
    public function show(){
        ...
        return view("gsu::admin.mpls-direct-access.mpls-direct-access-detail", ['request' => $res, 'btn' => $btn, 'servizi_plus' => $servizi_plus, 'servizi_access' => $servizi_access]);
    }
