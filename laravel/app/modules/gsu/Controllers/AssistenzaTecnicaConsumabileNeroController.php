...
class AssistenzaTecnicaConsumabileNeroController extends MainController {
    ...
    public function show(){
        ...
        return view("gsu::$this->view_folder.assistenza-tecnica-consumabile-nero.assistenza-tecnica-consumabile-nero-detail", ['request' => $res, 'btn' => $btn, 'servizi_plus' => $servizi_plus, 'servizi_access' => $servizi_access]);
    }
