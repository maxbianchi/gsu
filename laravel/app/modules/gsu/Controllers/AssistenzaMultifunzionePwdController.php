...
class AssistenzaMultifunzionePwdController extends MainController {
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.assistenza-tecnica-multifunzione-pwd.assistenza-tecnica-multifunzione-pwd", ['request' => $res, 'class' => $class]);
    }
    ...
    public function show(){
        ...
        return view("gsu::$this->view_folder.assistenza-tecnica-multifunzione-pwd.assistenza-tecnica-multifunzione-pwd-detail", ['request' => $res, 'btn' => $btn, 'users' => $users,'urlfiltering' => $urlfiltering, 'smartnet' => $smartnet, 'vpn' => $vpn, 'ipmultimedia' => $ipmultimedia, 'gestioneapparato' => $gestioneapparati]);
    }
