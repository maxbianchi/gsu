...
class IpstaticiController extends MainController {
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.ipstatici.ipstatici", ['request' => $res, 'class' => $class]);
    }
    ...
    public function show(){
        ...
        $res = $return['res'];
        $btn = $return['btn'];
        return view("gsu::$this->view_folder.ipstatici.ipstatici-detail", ['request' => $res, 'btn' => $btn]);
    }
