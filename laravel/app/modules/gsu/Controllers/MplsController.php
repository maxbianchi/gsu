...
class MplsController extends MainController {
    ...
    private $tableName = "MPLS ADSL DIRECT";
    ...
    public function main(){
        ...
        return view("gsu::$this->view_folder.mpls.mpls", ['request' => $res, 'class' => $class, 'tableName' => $this->tableName]);
    }
    ...
    public function show(){
        ...
        return view("gsu::$this->view_folder.mpls.mpls-detail", ['request' => $res, 'btn' => $btn, 'servizi_plus' => $servizi_plus, 'servizi_access' => $servizi_access, 'tableName' => $this->tableName]);
    }
