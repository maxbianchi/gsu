...
class ApparatiMobileModel extends Model {
    ...
    public function getAllRequest(){
        ...
        SELECT
			...
			RIGHT OUTER JOIN			UNIWEB.dbo.AOF70	richieste	ON APPARATI_MOBILE.codice_r				= richieste.MANUTENZIONE
...
EOF;
    ...
    public function saveData(){
        ...
        $dataacquisto = implode("-", array_reverse(explode("-", $dataacquisto)));
        ...
        $scadgaranziainiz = implode("-", array_reverse(explode("-", $scadgaranziainiz)));
        $ntelefono = Input::get('ntelefono');
        $scadrinnovogaranzia = empty(Input::get('scadrinnovogaranzia')) ? "00-00-0000" : Input::get('scadrinnovogaranzia');
        $scadrinnovogaranzia = implode("-", array_reverse(explode("-", $scadrinnovogaranzia)));
