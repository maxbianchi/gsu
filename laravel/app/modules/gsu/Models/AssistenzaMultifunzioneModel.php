...
class AssistenzaMultifunzioneModel extends Model {
    ...
    public function getAllRequest(){
        ...
        $sql = <<<EOF
			...
			ASSISTENZA_TECNICA_MULTIFUNZIONE.ELIMINATO
			FROM gsu.dbo.ASSISTENZA_TECNICA_MULTIFUNZIONE
			RIGHT OUTER JOIN UNIWEB.dbo.AOF70 richieste ON ASSISTENZA_TECNICA_MULTIFUNZIONE.codice_r = richieste.MANUTENZIONE
