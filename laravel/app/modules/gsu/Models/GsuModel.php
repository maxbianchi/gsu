...
class GsuModel extends Model {
    ...
    public function getAllRequest(){
        ...
        ISNULL(ROUND(RICHIESTE.VALOREUNITARIO, 2, 1), 0) VALOREUNITARIO,
        ISNULL(ROUND(FORMAT(RICHIESTE.FORMULASCONTO,DECIMAL), 2, 1), 0) FORMULASCONTO,
        ISNULL(ROUND(RICHIESTE.TOTRIGANETTO, 2, 1), 0) TOTRIGANETTO,
        ISNULL(ROUND(RICHIESTE.VALOREACQUISTO, 2, 1), 0) VALOREACQUISTO
        FROM
...
EOF;
    ...
    public function getFilteredRequest(){
        ...
        CASE WHEN (RICHIESTE.DATADISATTIVAZIONE > '1990-01-01') THEN CONVERT(VARCHAR(10),RICHIESTE.DATADISATTIVAZIONE,105) ELSE '' END  AS DATADISATTIVAZIONE,
        ISNULL(ROUND(RICHIESTE.VALOREUNITARIO, 2, 1), 0) VALOREUNITARIO,
        ISNULL(ROUND(RICHIESTE.FORMULASCONTO, 2, 1), 0) FORMULASCONTO,
        ISNULL(ROUND(RICHIESTE.TOTRIGANETTO, 2, 1), 0) TOTRIGANETTO,
        ISNULL(ROUND(RICHIESTE.VALOREACQUISTO, 2, 1), 0) VALOREACQUISTO
        FROM
        gsu.dbo.RICHIESTE_EVASE
