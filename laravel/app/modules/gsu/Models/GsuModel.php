...
class GsuModel extends Model {
    ...
    public function getAllRequest(){
        ...
        ISNULL(REPLACE(RICHIESTE.VALOREUNITARIO,'.',','), 0) VALOREUNITARIO,
        ISNULL(REPLACE(RICHIESTE.FORMULASCONTO,'.',','), 0) FORMULASCONTO,
        ISNULL(REPLACE(RICHIESTE.TOTRIGANETTO,'.',','), 0) TOTRIGANETTO,
        ISNULL(REPLACE(RICHIESTE.VALOREACQUISTO,'.',','), 0) VALOREACQUISTO
        FROM
