...
class GsuModel extends Model {
    ...
    public function getAllRequest(){
        ...
        ISNULL(ROUND(REPLACE(RICHIESTE.VALOREUNITARIO,'.',','), 2, 1), 0) VALOREUNITARIO,
        ISNULL(ROUND(REPLACE(RICHIESTE.FORMULASCONTO,'.',','), 2, 1), 0) FORMULASCONTO,
        ISNULL(ROUND(REPLACE(RICHIESTE.TOTRIGANETTO,'.',','), 2, 1), 0) TOTRIGANETTO,
        ISNULL(ROUND(REPLACE(RICHIESTE.VALOREACQUISTO,'.',','), 2, 1), 0) VALOREACQUISTO
        FROM
