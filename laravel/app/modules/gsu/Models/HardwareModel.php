    ...
    public function saveData(){
        ...
        try {
            if(empty($id)) {
                ...
                DB::update("Update SERVER  Set SERVER.SOGGETTO	 = '$soggetto', SERVER.CLIENTE = '$cliente', SERVER.DESTINATARIOABITUALE = '$destinatarioabituale', SERVER.ACQUISTO_NOLEGGIO = '$acquisto_noleggio', SERVER.MODELLO = '$modello', SERVER.PN = '$pn', SERVER.SN = '$sn', SERVER.PIN = '$pin', SERVER.DATAACQUISTO = convert(datetime, '$dataacquisto',105), SERVER.SCADGARANZIAINIZ = convert(datetime, '$scadegaranziainiz',105), SERVER.RINNOVOGARANZIA = '$rinnovogaranzia', SERVER.ACERADVANTAGE = '$aceradvantage', SERVER.PSWACER = '$pswacer', SERVER.NUMEROENERGYCARD = '$numeroenergycard', SERVER.SOSCLIENTE = '$soscliente', SERVER.SOSCONTRATTO = '$soscontratto', SERVER.SCADRINNOVOGARANZIA = convert(datetime, '$scadrinnovogaranzia',105), SERVER.MARCA = '$marca', SERVER.DATA_R = '$data_r',ELIMINATO = $eliminato WHERE IDSERVER=$id");
