...
class Canoni{
    ...
    public function __construct(){
        ...
        $this->canoni['/gsu/linea_aggiuntiva'] = ['CAN-B201', 'CAN-B201B'];
        ...
        $this->canoni['/gsu/sim_m2m'] = ['CAN-I011A', 'CAN-I011B'];
        $this->canoni['/gsu/sim_twin'] = ['CAN-I021B', 'CAN-I022B'];
        $this->canoni['/gsu/sim_extension'] = ['CAN-I031B'];
        $this->canoni['/gsu/sim_fax_dati'] = ['CAN-I041B'];
        $this->canoni['/gsu/sim_opzioni_roaming'] = ['CAN-I051B', 'CAN-I052B', 'CAN-I053B', 'CAN-I054B', 'CAN-I055B', 'CAN-I056B', 'CAN-I057B', 'CAN-I058B', 'CAN-I051-001B', 'CAN-I051-003B', 'CAN-I051-004B'];
        $this->canoni['/gsu/sim_opzioni_intercom'] = ['CAN-I061B', 'CAN-I062B', 'CAN-I063B', 'CAN-I064B', 'CAN-I065B', 'CAN-I066B'];
        $this->canoni['/gsu/sim_tassa_ministeriale'] = ['CAN-I101B'];
        $this->canoni['/gsu/sim_assistenza_tecnica'] = ['CAN-I201B'];
        $this->canoni['/gsu/sim_opzione_dati'] = ['CAN-I111B', 'CAN-I112B', 'CAN-I113B', 'CAN-I114B', 'CAN-I115B', 'CAN-I116B', 'CAN-I117B', 'CAN-I118B', 'CAN-I119-001B','CAN-I119-002B', 'CAN-I119-003B','CAN-I119-004B','CAN-I119-005B','CAN-I119-006B','CAN-I119-007B', 'CAN-I120-001B', 'CAN-I120-002B', 'CAN-I119-008B' , 'CAN-I119-009B' , 'CAN-I119-010B' , 'CAN-I119-011B' , 'CAN-I119-012B' , 'CAN-I120-003B' , 'CAN-I120-004B', 'CAN-I119-013B', 'CAN-I119-014B', 'CAN-I119-015B', 'CAN-I119-016B', 'CAN-I119-017B', 'CAN-I119-018B', 'CAN-I119-019B', 'CAN-I119-020B', 'CAN-I119-021B'];
        $this->canoni['/gsu/sim_filtro_accessi'] = ['CAN-I211-001B', 'CAN-I212-001B', 'CAN-I213-001B', 'CAN-I214-001B', 'CAN-I215-001B', 'CAN-I216-001B', 'CAN-I217-001B', 'CAN-I217-001B', 'CAN-I219-001B'];
        $this->canoni['/gsu/apparati_networking'] = ['CAN-B102B', 'CAN-B103M', 'CAN-B103B', 'CAN-D103B', 'CAN-F022A', 'CAN-F022B', 'CAN-F022M', 'CAN-F021B'];
        $this->canoni['/gsu/assistenza_centralini'] = ['CAN-G001A', 'CAN-G001B'];
        $this->canoni['/gsu/servizi_plus'] = ['CAN-G071-001B', 'CAN-G071-002B', 'CAN-G071-003B', 'CAN-G072-001B', 'CAN-G073-001B', 'CAN-G073-002B'];
        $this->canoni['/gsu/multifunzione'] = ['CAN-F101A', 'CAN-F101B'];
        $this->canoni['/gsu/apparati_mobile'] = ['CAN-F301A', 'CAN-F301B'];
        $this->canoni['/gsu/centralini'] = ['CAN-F201B', 'CAN-F201A', 'CAN-F202B', 'CAN-F202A', 'CAN-F203B', 'CAN-F203A', 'CAN-F204B', 'CAN-F204A'];
        $this->canoni['/gsu/assistenza_tecnica_multifunzione'] = ['CAN-G081A', 'CAN-G081B'];
        $this->canoni['/gsu/consumabile_nero'] = ['CAN-G082-001B'];
        $this->canoni['/gsu/consumabile_colori'] = ['CAN-G082-002B'];
        $this->canoni['/gsu/assistenza_tecnica_hardware'] = ['CAN-G101A','CAN-G101M', 'CAN-G102A', 'CAN-G105A', 'CAN-G106A', 'CAN-G107A', 'CAN-G102-001A', 'CAN-G105-001A', 'CAN-G106-001A', 'CAN-G107-001A', 'CAN-G101B'];
        $this->canoni['/gsu/hardware'] = ['CAN-F401A', 'CAN-F401B'];
        $this->canoni['/gsu/mail_server'] = ['CAN-G104A'];
        $this->canoni['/gsu/utente_aggiuntivo_ms'] = ['CAN-G104-001A'];
        $this->canoni['/gsu/terminal_server'] = ['CAN-G103A'];
        $this->canoni['/gsu/utente_aggiuntivo'] = ['CAN-G101-001A'];
        $this->canoni['/gsu/utente_aggiuntivo_ts'] = ['CAN-G103-001A'];
        $this->canoni['/gsu/assistenza_tecnica'] = ['CAN-G002A', 'CAN-G002B'];
        $this->canoni['/gsu/servizi_access'] = ['CAN-G061', 'CAN-G061A', 'CAN-G061B', 'CAN-G062', 'CAN-G062A', 'CAN-G062B'];
        $this->canoni['/gsu/caselle'] = ['CAN-E062A', 'CAN-E062B', 'CAN-E061B', 'CAN-E061A', 'CAN-E061M', 'CAN-E063A', 'CAN-E063B', 'CAN-E064A', 'CAN-E064B', 'CAN-E11A', 'CAN-E11B', 'CAN-E111A', 'CAN-E111B', 'CAN-E112A', 'CAN-E112B', 'CAN-E113A', 'CAN-E113B'];
        $this->canoni['/gsu/caselle_relay'] = ['CAN-E081A', 'CAN-E081B', 'CAN-E082-001A', 'CAN-E082-002A', 'CAN-E082-003A', 'CAN-E082-004A', 'CAN-E082-005A', 'CAN-E082-006A', 'CAN-E082-007A', 'CAN-E082-008A', 'CAN-E082-009A', 'CAN-E082-010A', 'CAN-E082-001B', 'CAN-E082-002B', 'CAN-E082-003B', 'CAN-E082-004B', 'CAN-E082-005B', 'CAN-E082-006B', 'CAN-E082-007B', 'CAN-E082-008B', 'CAN-E082-009B', 'CAN-E082-010B'];
        ...
        $this->canoni['/gsu/direct_access'] = ['CAN-D011B', 'CAN-D012B', 'CAN-D013B', 'CAN-D014B', 'CAN-D015B', 'CAN-D016B', 'CAN-D017B', 'CAN-D018B', 'CAN-D019B', 'CAN-D021B', 'CAN-D022B', 'CAN-D023B', 'CAN-D024B', 'CAN-D025B', 'CAN-D026B', 'CAN-D027B', 'CAN-D028B', 'CAN-D028M', 'CAN-D042B', 'CAN-D051B', 'CAN-D052B', 'CAN-D053B', 'CAN-D033B', 'CAN-D054B', 'CAN-D055B'];
        ...
        $this->canoni['/gsu/motori_di_ricerca'] = ['CAN-E041A', 'CAN-E041B'];
        ...
        $this->canoni['/gsu/gestione_apparato'] = ['CAN-G022A', 'CAN-G022B'];
        ...
        $this->canoni['/gsu/mpls_direct_access'] = ['CAN-M001M', 'CAN-M001B', 'CAN-M002M', 'CAN-M002B', 'CAN-M003M', 'CAN-M003B', 'CAN-M004M', 'CAN-M004B', 'CAN-M005B', 'CAN-M006B', 'CAN-M007B', 'CAN-M008B', 'CAN-M011B', 'CAN-M021B', 'CAN-M031B'];
        $this->canoni['/gsu/web_hat'] = ['CAN-E071A', 'CAN-E071B', 'CAN-E072A', 'CAN-E072B', 'CAN-E073A', 'CAN-E073B', 'CAN-E074A', 'CAN-E074B', 'CAN-E075A'];
        ...
        $this->canoni['/gsu/unigate_numeri'] = ['CAN-H102A', 'CAN-H102B','CAN-H101A', 'CAN-H101B'];
        $this->canoni['/gsu/url_filtering'] = ['CAN-F031A', 'CAN-F031B'];
