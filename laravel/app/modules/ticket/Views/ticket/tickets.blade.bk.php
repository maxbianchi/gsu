            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tre"><h1>Servizio</h1>
                    <table border="0" class="tabella dataTable table table-striped table-bordered display no-footer detail">
                        <tr>
                            <td>TGU</td>
                            <td><input type="text" style="background-color: #FFC;" name="tgu" id="tgu" value="{{$res['TGU'] or ""}}"></td>
                            <td>IMEI</td>
                            <td><input type="text" style="background-color: #FFC;" name="imei" id="imei" value="{{$res['IMEI'] or ""}}"></td>
                        </tr>
                        <tr>
                            <td>TEL</td>
                            <td><input type="text" style="background-color: #FFC;" name="tel" id="tel" value="{{$res['TEL'] or ""}}"></td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
