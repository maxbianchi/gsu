                ...
                <table style="width:100%;font-family: Arial; font-size:10px;" cellpadding="0" cellspacing="0">
                    <tr>
                        <td valign="top" style="width:30%;">
                            <img src="{{ URL::asset('images/loghi_verbalino.png') }}" alt="Uniweb 4.0 Dashboard" style="height:415px;" title="Uniweb 4.0 Dashboard">
                        </td>
                                ...
                                <table>
                                    <tr>
                                        <td style="width:100pt;text-align:left;" valign="top">
                                            <img src="{{ URL::asset('images/logo1.png') }}" style="width:100%;">
                                        </td>
