...
class ClientiModel extends Model {
   ...
   public function getAllStorico($idattivita){
       $sql = "SELECT *, CONVERT(VARCHAR(15),STORICO.DATA,105) DATACAMBIOSTATO, CONVERT(VARCHAR(15),STORICO.DATA,108) ORACAMBIOSTATO FROM TICKET.dbo.STORICO INNER JOIN TICKET.dbo.STATI ON STORICO.IDSTATO = STATI.IDSTATO WHERE STORICO.IDATTIVITA='$idattivita' ORDER BY ID ASC";
